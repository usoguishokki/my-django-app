...
export function createCardWorkInputPanel({
    ...
    const header = createInputPanelHeader({ readOnly });
    ...
    const actions = createInputPanelActions({ readOnly });
...
function createInputPanelBody({
    ...
    form.append(
        ...
        createImplementationContentField({ inputState, readOnly }),
        ...
        createCommentField({ inputState, readOnly })
    );
...
function createInputPanelActions({ readOnly = false } = {}) {
...
function createImplementationDateTimeField({
    ...
    wrapper.innerHTML = renderDateTimeFieldHTML({
        ...
        attrs: readOnly ? { readonly: true } : { required: true },
    });
...
function createPractitionerField({
    ...
    confirmButton.disabled = readOnly;
