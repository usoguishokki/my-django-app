# Generated by Django 4.2.14 on 2026-02-19 19:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(set_initial_password), 
        migrations.CreateModel(
            name='Affilation_tb',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anchor_year', models.IntegerField(blank=True, null=True, verbose_name='anchor_year')),
                ('anchor_month', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='anchor_month')),
                ('week_of_month', models.PositiveSmallIntegerField(blank=True, choices=[(1, '1週目'), (2, '2週目'), (3, '3週目'), (4, '4週目'), (6, '予備週')], null=True)),
                ('day_of_week', models.PositiveSmallIntegerField(blank=True, choices=[(0, '月'), (1, '火'), (2, '水'), (3, '木'), (4, '金'), (5, '土'), (6, '日')], null=True)),
                ('time_zone', models.CharField(choices=[('RUNNING', '稼働中'), ('STOPPED', '停止中')], default='RUNNING', max_length=10)),
                ('status', models.CharField(choices=[('PERIODIC', '定期点検'), ('MAKER', 'メーカ'), ('ABOLISHED', '廃止'), ('DAILY', '日常点検'), ('AUTOMATE', '自動化'), ('SymptomMgmt', '兆候管理')], default='PERIODIC', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('h_week', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(6)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('implementation_date', models.DateTimeField(blank=True, null=True, verbose_name='implementation_date')),
        ...
        migrations.CreateModel(
            name='PlanRuleCondition',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cond_type', models.CharField(choices=[('DAY_OF_WEEK', 'Day of week'), ('WEEK_PARITY', 'Week parity'), ('DATE_TAG', 'Date tag')], max_length=32)),
                ('op', models.CharField(choices=[('EQ', 'Equals'), ('IN', 'In')], max_length=8)),
        ...
        migrations.CreateModel(
            name='PlanScheduleRule',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('unit', models.CharField(choices=[('D', 'Day'), ('W', 'Week'), ('M', 'Month'), ('Y', 'Year')], max_length=1)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['unit', 'interval'], name='plan_schedu_unit_72e210_idx')],
            },
        ),
        migrations.AddConstraint(
            model_name='planschedulerule',
            constraint=models.CheckConstraint(check=models.Q(('interval__gte', 1)), name='plan_schedule_rule_interval_gte_1'),
        ),
        migrations.AddField(
            model_name='planrulecondition',
            name='rule',
            field=models.ForeignKey(db_column='rule_id', on_delete=django.db.models.deletion.CASCADE, related_name='conditions', to='myapp.planschedulerule'),
        ),
        migrations.AddField(
            model_name='planapproval',
            name='member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plan_approvals', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='planapproval',
            name='plan',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='myapp.plan_tb'),
        ),
        migrations.AddField(
            model_name='plan_tb',
            name='applicant',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='applied_plans', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='plan_tb',
            name='approver',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approved_plans', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='plan_tb',
            name='holder',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='holder_plans', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='plan_tb',
            name='inspection_no',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='plans', to='myapp.check_tb'),
        ),
        migrations.AddField(
            model_name='plan_tb',
            name='p_date',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='plans_by_date', to='myapp.hozen_calendar_tb'),
        ),
        migrations.AddField(
            model_name='linename_tb',
            name='organization',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='linenames', to='myapp.organization'),
        ),
        migrations.AddField(
            model_name='db_details_tb',
            name='inspection_no',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='db_details', to='myapp.check_tb'),
        ),
        migrations.AddField(
            model_name='control_tb',
            name='line_name',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='linenames', to='myapp.linename_tb'),
        ),
        migrations.AddField(
            model_name='check_tb',
            name='control_no',
        ...
        migrations.AddField(
            model_name='check_tb',
            name='rule_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='checks', to='myapp.planschedulerule'),
        ),
        migrations.AddField(
            model_name='calendar_tb',
            name='affilation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='calendars', to='myapp.affilation_tb'),
        ),
        migrations.AddField(
            model_name='calendar_tb',
            name='c_date',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='calendars', to='myapp.hozen_calendar_tb'),
        ),
        migrations.AddField(
            model_name='calendar_tb',
            name='pattern',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='calendars', to='myapp.shiftpattan_tb'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='planrulecondition',
            index=models.Index(fields=['rule', 'cond_type'], name='plan_rule_c_rule_id_40ce34_idx'),
        ),
        migrations.AddConstraint(
            model_name='planrulecondition',
            constraint=models.UniqueConstraint(fields=('rule', 'cond_type', 'op'), name='uniq_rule_condtype_op'),
        ),
        migrations.AddConstraint(
            model_name='check_tb',
            constraint=models.CheckConstraint(check=models.Q(('anchor_month__isnull', True), models.Q(('anchor_month__gte', 1), ('anchor_month__lte', 12)), _connector='OR'), name='check_tb_anchor_month_null_or_1_12'),
        ),
        migrations.AddConstraint(
            model_name='check_tb',
            constraint=models.CheckConstraint(check=models.Q(('anchor_year__isnull', True), ('anchor_year__gte', 1), _connector='OR'), name='check_tb_anchor_year_null_or_gte_1'),
        ),
        migrations.AddConstraint(
            model_name='check_tb',
            constraint=models.CheckConstraint(check=models.Q(('week_of_month__isnull', True), ('week_of_month__in', [1, 2, 3, 4, 6]), _connector='OR'), name='check_tb_week_of_month_null_or_valid'),
        ),
        migrations.AddConstraint(
            model_name='check_tb',
            constraint=models.CheckConstraint(check=models.Q(('day_of_week__isnull', True), ('day_of_week__in', [0, 1, 2, 3, 4, 5, 6]), _connector='OR'), name='check_tb_day_of_week_null_or_0_6'),
        ),
    ]
